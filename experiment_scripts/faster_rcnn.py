...
from imagelog_ai.features.methodologies.faster_rcnn.datasets.dataset import (
    FasterRCNNDataset,
)
from imagelog_ai.features.methodologies.faster_rcnn.modules.lit_module import (
    LitFasterRCNN,
)
...
def transform_func(x):
    ...
    x = FasterRCNN_ResNet50_FPN_V2_Weights.DEFAULT.transforms()(x)
    return x
...
lit_model = LitFasterRCNN(num_classes=2, batch_size=project_settings["batch_size"])
print(lit_model)
