...
from imagelog_ai.features.methodologies.detr.utils import box_ops
...
from imagelog_ai.features.methodologies.detr.neural_networks.backbone import (
    build_backbone,
)
from imagelog_ai.features.methodologies.detr.neural_networks.matcher import (
    build_matcher,
)
from imagelog_ai.features.methodologies.detr.neural_networks.segmentation import (
    DETRsegm,
    PostProcessPanoptic,
    PostProcessSegm,
    dice_loss,
...
from imagelog_ai.features.methodologies.detr.neural_networks.transformer import (
    build_transformer,
)
    ...
    def forward(self, samples: NestedTensor):
        ...
        It returns a dict with the following elements:
           ...
           - "pred_boxes": The normalized boxes coordinates for all queries, represented as
                           ...
                           See PostProcess for information on how to retrieve
                           the unnormalized bounding box.
...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        The target boxes are expected in format (center_x, center_y, w, h), normalized
            by the image size.
        """
    ...
    def loss_masks(self, outputs, targets, indices, num_boxes):
        ...
        targets dicts must contain the key "masks"
            containing a tensor of dim [nb_target_boxes, h, w]
        """
    ...
    def get_loss(self, loss, outputs, targets, indices, num_boxes, **kwargs):
        """
        Compute the specified loss for the given outputs and targets.
        Args:
            loss (str): The type of loss to compute.
                Must be one of "labels", "cardinality", "boxes", or "masks".
            outputs (dict): The model outputs.
            targets (list): The ground truth targets.
            indices (list): The matched indices between outputs and targets.
            num_boxes (int): The number of target boxes.
            **kwargs: Additional arguments specific to the loss function.
        Returns:
            torch.Tensor: The computed loss value.
        Raises:
            AssertionError: If the specified loss type is not in the loss_map.
        """
        loss_map = {
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        Parameters:
            ...
            target_sizes: tensor of dimension [batch_size x 2] containing the size of each
                images of the batch
...
def build(args):
    """
    Build the DETR model along with its criterion and postprocessors.
    Args:
    ...
    Returns:
        tuple: A tuple containing the following elements:
            ...
            - criterion: The criterion for training the model.
            - postprocessors: A dictionary of postprocessors for the model's outputs.
    """
    ...
    if args.num_classes is not None:
        print(f"Building a DETR model with {args.num_classes} classes")
